...
';
	 ...
	 *
	 * @param string $title to label
	 * @param string $content HTML content for the forth table cell.
	 * @param string $checkboxContent
	 * @return string HTML table row.
	 */
	public function extGetItem($title, $content = '', $checkboxContent = '') {
		return parent::extGetItem($title, $content, $checkboxContent);
	}
}
